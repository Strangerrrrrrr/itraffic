...
<table>
 <tr>
     ...
     <TABLE cellSpacing=0 cellPadding=0 width=740 border=0>
        ...
        <TR>
         ...
         <TR>
          ...
          <TD class=form-star></TD>
          <TD class=form-right> <img src="images/button_sure.gif" onClick="javascript:location.href='../zhifu.php?id=<?php echo $_GET["id"];?>&biao=<?php echo $_GET["biao"];?>';"></TD>
        </TR>
</TABLE>
   </td>
   ...
   <fieldset>
      <P class=STYLE1>本通道为<a href="http://www.jingmeiru.net" target="_blank"><strong>泰华物业水电费管理系统收款帐号：xxxx</strong></a>客户专用，采用支付宝付款。请在支付前与本网站达成一致。</P>
      <P class="style2">请务必与<a href="http://www.jingmeiru.net" target="_blank"><strong>泰华物业水电费管理系统收款帐号：xxxx</strong></a>确认好订单和货款后，再付款。可以在快速付款通道里的“标题”、“订单金额”、“付款方”和备注中填入相应的订单信息。</P>

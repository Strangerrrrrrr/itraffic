...
<p align="center"><a href="xinwentongzhi_list2.php?pagecurrent=1&lb=<?php echo $lb?>">首页</a>, <a href="xinwentongzhi_list2.php?pagecurrent=<?php echo $pagecurrent-1;?>&lb=<?php echo $lb?>">前一页</a> ,<a href="xinwentongzhi_list2.php?pagecurrent=<?php echo $pagecurrent+1;?>&lb=<?php echo $lb?>">后一页</a>, <a href="xinwentongzhi_list2.php?pagecurrent=<?php echo $pagecount;?>&lb=<?php echo $lb?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>

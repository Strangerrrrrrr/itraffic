...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  ...
  <?php 
    $sql="select * from weizhangxinxi where zhanghao='".$_SESSION['username']."'";
	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ...
  <tr>
    ...
    <td align='center'><?php echo mysql_result($query,$i,iszf);?>  <?php if(mysql_result($query,$i,iszf)=="否"){?><a href="zhifu/index.php?id=<?php echo mysql_result($query,$i,id);?>&biao=weizhangxinxi">支付</a> <?php } ?> </td>
    
    <td width="120" align="center"><?php echo mysql_result($query,$i,"addtime");?></td>
    <td width="70" align="center">
	  <a href="shensu_add.php?id=<?php echo mysql_result($query,$i,"id");?>">申诉</a>
	 <a href="weizhangxinxidetail.php?id=<?php echo mysql_result($query,$i,"id");?>" target="_blank">详细</a></td>
  </tr>
  	<?php
	}
}
...
<p align="center"><a href="weizhangxinxi_list2.php?pagecurrent=1">首页</a>, <a href="weizhangxinxi_list2.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="weizhangxinxi_list2.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="weizhangxinxi_list2.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>

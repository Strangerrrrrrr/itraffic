...
if ($addnew=="1" )
{
	...
	//lixandonxgjixelxb
	$sql="update shensu set paizhao='$paizhao',zhanghao='$zhanghao',weizhangleixing='$weizhangleixing',weizhangshijian='$weizhangshijian',didian='$didian',koufen='$koufen',fakuan='$fakuan',shenshuneirong='$shenshuneirong',shijian='$shijian' where id= ".$id;
	mysql_query($sql);
...
<!--hxsglxiangdxongjxs-->
<body>
<p>修改申诉： 当前日期： <?php echo $ndate; ?></p>
<?php
$sql="select * from shensu where id=".$id;

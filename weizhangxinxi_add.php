...
if ($addnew=="1" )
{
	...
	$sql="insert into weizhangxinxi(paizhao,zhanghao,weizhangleixing,weizhangshijian,didian,koufen,fakuan) values('$paizhao','$zhanghao','$weizhangleixing','$weizhangshijian','$didian','$koufen','$fakuan') ";
	mysql_query($sql);
...
<body>
<p>添加违章信息： 当前日期： <?php echo $ndate; ?></p>
<script language="javascript">
	function check()
{
	...
	function gow()
	{
		location.href='weizhangxinxi_add.php?jihuabifffanhao='+document.form1.jihuabifffanhao.value+"&id=<?php echo $_GET["id"]?>";
	}
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">    
    ...
    <tr><td>违章类型：</td><td><input name='weizhangleixing' type='text' id='weizhangleixing' value='' style='border:solid 1px #000000; color:#666666' />&nbsp;*</td></tr>
    <tr><td>违章时间：</td><td><input name='weizhangshijian' type='text' id='weizhangshijian' value='' onclick="WdatePicker({'dateFmt':'yyyy-MM-dd HH:mm:ss'})" style='border:solid 1px #000000; color:#666666; width:125px;' />&nbsp;*</td></tr>
    <tr><td>地点：</td><td><input name='didian' type='text' id='didian' value='' style='border:solid 1px #000000; color:#666666' />&nbsp;*</td></tr>
    <tr><td>扣分：</td><td><input name='koufen' type='text' id='koufen' value='' style='border:solid 1px #000000; color:#666666' />&nbsp;*&nbsp;必需数字型</td></tr>
    <tr><td>罚款：</td><td><input name='fakuan' type='text' id='fakuan' value='' style='border:solid 1px #000000; color:#666666' />&nbsp;*&nbsp;必需数字型</td></tr>
    <tr style='display:none'><td>反馈：</td><td><input name='fankui' type='text' id='fankui' value='' style='border:solid 1px #000000; color:#666666' /></td></tr>

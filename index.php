						...
						?>
                            <tr>
                              ...
                              <td width="76%" height="25"><a  href="gg_detail.php?id=<?php echo mysql_result($query,$i,"id");?>" 
								...
								?></a></td>
                              <td width="20%" height="25" align="right"><SPAN style="FONT-SIZE: 9pt; COLOR: #b5a073; FONT-FAMILY: 宋体">[<?php echo date("Y-m-d",strtotime(mysql_result($query,$i,"addtime")));?>]</SPAN></td>
                            </tr>
                             <?php
						}
					  }
